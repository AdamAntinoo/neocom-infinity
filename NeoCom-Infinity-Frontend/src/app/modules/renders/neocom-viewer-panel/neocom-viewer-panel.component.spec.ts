...
import { NeocomViewerPanelComponent } from './neocom-viewer-panel.component';
// - PROVIDERS
...
describe('PANEL NeocomViewerPanelComponent [Module: CORE]', () => {
    let component: NeocomViewerPanelComponent;
    ...
    beforeEach(() => {
        TestBed.configureTestingModule({
            ...
            .compileComponents();
        const fixture = TestBed.createComponent(NeocomViewerPanelComponent);

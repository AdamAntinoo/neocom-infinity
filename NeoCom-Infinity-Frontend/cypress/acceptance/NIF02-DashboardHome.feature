...
Feature: [NIF02]-Display the character dashboard page.
    ...
    @NIF02  @NIF02.05
    Scenario: [NIF02.05]-Check the existence of the right Features at the dashboard page and that move to the right pages.
        When the page "Pilot Dashboard" is activated
        ...
        Then the Feature has the label "Gestion de Industria"
        When the Feature with label "Gestion de Industria" is clicked the destination is the Page "Industry Dashboard"
        When the page "Pilot Dashboard" is activated

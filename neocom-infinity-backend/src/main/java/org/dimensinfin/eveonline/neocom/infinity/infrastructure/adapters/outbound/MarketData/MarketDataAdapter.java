...
public class MarketDataAdapter implements MarketDataPort {
	...
	public V2MarketDataDto getMarketData4TypeAtStation( final int typeId, final int stationId ) {
		return marketDataCache.computeIfAbsent( this.getCacheIdentifier( typeId, stationId ),
				k -> this.marketDataProvider.getMarketData4TypeAtStation( typeId, stationId )
		);
	}
	...
	private String getCacheIdentifier( final int typeId, final int stationId ) {

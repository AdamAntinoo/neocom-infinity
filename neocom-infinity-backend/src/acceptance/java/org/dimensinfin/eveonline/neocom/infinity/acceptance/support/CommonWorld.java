...
public class CommonWorld {
	...
	private NeoComRuntimeBackendExceptionObsolete applicationException;
	private List<String> cookies = new ArrayList<>();
	@Deprecated
	private UUID id;

	// - G E T T E R S   &   S E T T E R S
	public NeoComRuntimeBackendExceptionObsolete getApplicationException() {
		return this.applicationException;
	}

	public CommonWorld setApplicationException( final NeoComRuntimeBackendExceptionObsolete applicationException ) {

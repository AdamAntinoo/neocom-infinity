...
public interface CharacterApi {
    ...
    ResponseEntity<List<Object>> getCharacterBlueprints(
        ...
        @NotNull @Parameter(name = "NEOCOM-TOKEN", description = "The access token to be used for authorization. This token will contain information to locate the credential to be used for data location.", required = true, in = ParameterIn.HEADER) @RequestHeader(value = "NEOCOM-TOKEN", required = true) String NEOCOM_TOKEN
    );

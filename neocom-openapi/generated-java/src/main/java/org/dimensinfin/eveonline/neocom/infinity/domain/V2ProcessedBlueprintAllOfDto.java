...
/**
 * V2ProcessedBlueprintAllOfDto
 */
@JsonPropertyOrder({
  V2ProcessedBlueprintAllOfDto.JSON_PROPERTY_TYPE_ID,
  V2ProcessedBlueprintAllOfDto.JSON_PROPERTY_BLUEPRINT_ITEN,
  V2ProcessedBlueprintAllOfDto.JSON_PROPERTY_LOCATION,
  V2ProcessedBlueprintAllOfDto.JSON_PROPERTY_MATERIAL_EFFICIENCY,
  V2ProcessedBlueprintAllOfDto.JSON_PROPERTY_TIME_EFFICIENCY,
  V2ProcessedBlueprintAllOfDto.JSON_PROPERTY_OUTPUT_TYPE_ID,
  V2ProcessedBlueprintAllOfDto.JSON_PROPERTY_OUTPUT_ITEM,
  V2ProcessedBlueprintAllOfDto.JSON_PROPERTY_MANUFACTURE_COST,
  V2ProcessedBlueprintAllOfDto.JSON_PROPERTY_OUTPUT_COST,
  V2ProcessedBlueprintAllOfDto.JSON_PROPERTY_BOM,
  V2ProcessedBlueprintAllOfDto.JSON_PROPERTY_INDEX
})
@JsonTypeName("v2_ProcessedBlueprint_allOf")
@lombok.Builder
@lombok.Data
@lombok.AllArgsConstructor
@lombok.NoArgsConstructor
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen")
public class V2ProcessedBlueprintAllOfDto {

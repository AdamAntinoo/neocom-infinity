 ...
 */
@JsonPropertyOrder({
  V1EsiTypeDto.JSON_PROPERTY_JSON_CLASS,
  V1EsiTypeDto.JSON_PROPERTY_TYPE_ID,
  V1EsiTypeDto.JSON_PROPERTY_NAME,
  V1EsiTypeDto.JSON_PROPERTY_GROUP_ID,
  V1EsiTypeDto.JSON_PROPERTY_GROUP_NAME,
  V1EsiTypeDto.JSON_PROPERTY_CATEGORY_ID,
  V1EsiTypeDto.JSON_PROPERTY_CATEGORY_NAME
})
@JsonTypeName("v1.EsiType")
@lombok.Builder
@lombok.Data
@lombok.AllArgsConstructor
@lombok.NoArgsConstructor
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen")
public class V1EsiTypeDto {

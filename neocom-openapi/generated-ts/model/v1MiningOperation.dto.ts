 ...
 */
import { V1StackDto } from './v1Stack.dto';


export interface V1MiningOperationDto { 
    /**
    ...
    date: string;
    /**
     * The Eve system link to the Location Provider to get a complete Eve Location.
     */
    solarSystemLink: string;
    resources: Array<V1StackDto>;
}

...
Feature: [NIN03] Create aggregated data models for the EsiType and complementaty data.
  ...
  @NIN03 @NIN03.01
  Scenario: [NIN03.01] Create on additional endpoint to access the EsiType structure removing hierarchy data for Group and Category.
  ...
  @NIN03 @NIN03.02
  Scenario: [NIN03.02] New endpoint to get Market Data for a type at a Region.
    Given a request for EsiType with type 17464

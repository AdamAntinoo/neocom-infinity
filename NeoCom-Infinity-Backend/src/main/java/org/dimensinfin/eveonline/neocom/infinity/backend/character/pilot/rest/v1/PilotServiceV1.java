...
public class PilotServiceV1 extends NeoComAuthenticatedService {
	...
	public PilotServiceV1( @NotNull final ESIDataService esiDataService,
		...
		super( esiDataService, neoComAuthenticationProvider, credentialDetailsService );
	...
	private PilotV1 pilotV1Generator( final Credential credential ) {
		...
		return new PilotV1.Builder()
				...
				.withCorporation( this.characterService.getCorporationPublicData( pilotData.getCorporationId() ) )

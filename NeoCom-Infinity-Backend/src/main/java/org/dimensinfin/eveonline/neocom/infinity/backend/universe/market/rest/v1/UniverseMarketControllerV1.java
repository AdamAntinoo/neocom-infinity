...
import org.dimensinfin.eveonline.neocom.infinity.backend.market.rest.v1.MarketServiceV1;
...
public class UniverseMarketControllerV1 {
	...
	public UniverseMarketControllerV1( final @NotNull MarketServiceV1 marketServiceV1 ) {this.marketServiceV1 = marketServiceV1;}
	...
	public ResponseEntity<MarketData> getMarketConsolidatedByRegion4ItemId(
		...
		return new ResponseEntity<>( this.marketServiceV1.getMarketConsolidatedByRegion4ItemId( regionId, typeId ), HttpStatus.OK );
	}
}
export const environment = {
    ...
    serverName: '',
    loginLink: "https://login.eveonline.com/v2/oauth/authorize/?response_type=code&client_id=365122836bbb4f6d875aa5548426abf1&state=LU5FT0NPTS5JTkZJTklUWS1QUk9EVUNUSU9OLVZBTElEIFNUQVRFIFNUUklORy0=&redirect_uri=https%3A%2F%2Fhttp://localhost:32000/%2Fapp%2FloginValidation&scope=publicData%20esi-location.read_location.v1%20esi-location.read_ship_type.v1%20esi-skills.read_skills.v1%20esi-skills.read_skillqueue.v1%20esi-wallet.read_character_wallet.v1%20esi-search.search_structures.v1%20esi-universe.read_structures.v1%20esi-location.read_online.v1",
    loginLinkData: {

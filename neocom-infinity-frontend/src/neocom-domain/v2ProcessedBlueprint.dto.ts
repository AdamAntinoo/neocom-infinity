import { V1EsiTypeDto, V1SpaceLocationDto, V1StackDto } from 'neocom-domain'
 ...
 */
export interface V2ProcessedBlueprintDto {
	/**
	...
	uid: string
	typeId?: number
	blueprint?: V1EsiTypeDto
	output?: V1EsiTypeDto
	location?: V1SpaceLocationDto
	billOfmaterials?: Array<V1StackDto>

...
export class AuthenticationService {
    ...
    public isAuthenticated(): boolean {
        const jwtTokenData = this.isolationService.getFromSession(STORAGE_LINKS.JWTTOKEN_KEY)
        if (jwtTokenData)
    ...
    public isLoggedIn(): boolean {
        const jwtToken = this.isolationService.getFromSession(STORAGE_LINKS.JWTTOKEN_KEY);
    ...
    public isExpiredToken(): boolean {
        console.log('-[AuthenticationService.isExpiredToken]> expiration time: ' +
            this.isolationService.getFromSession(
                STORAGE_LINKS.JWTTOKEN_EXPIRATION_TIME_KEY));
    ...
    public storeJwtToken(newToken: string): void {
        this.isolationService.setToSession(STORAGE_LINKS.JWTTOKEN_KEY, newToken);
        ...
        this.isolationService.setToSession(STORAGE_LINKS.JWTTOKEN_EXPIRATION_TIME_KEY, expirationTime);
    }
    /** @deprecated */
    ...
    public clearJwtToken(): void {
        this.isolationService.removeFromSession(STORAGE_LINKS.JWTTOKEN_KEY);
        this.isolationService.removeFromSession(STORAGE_LINKS.JWTTOKEN_EXPIRATION_TIME_KEY);
    }

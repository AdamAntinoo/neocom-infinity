...
export class SupportService {
	...
	constructor() {
		...
		this.translationTable['Available Blueprints By Category'] = 'v1-blueprint-list-page'
		...
		this.routeTranslationTable['Available Blueprints By Category'] = '/industry/manufacture/blueprints'
	}
	/**

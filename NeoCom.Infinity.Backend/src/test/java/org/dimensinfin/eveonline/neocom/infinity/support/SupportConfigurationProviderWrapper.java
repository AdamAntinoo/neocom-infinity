...
@Deprecated
@Component
public class SupportConfigurationProviderWrapper extends SBConfigurationService {
// - C O N S T R U C T O R S
	...
	public void readAllProperties() {
		...
		this.addProperty( "P.esi.tranquility.authorization.content.type", "application/json" );
		this.addProperty( "P.authenticated.retrofit.server.location", "http://localhost:6091/" );

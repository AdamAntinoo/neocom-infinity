...
public class FittingListControllerTest {
	@Test
...
//		final Integer pilotId = 93813310;
		final FittingListController fittingListController = new FittingListController( fittingService, neoComAuthenticationProvider );
		...
		NeoComAuthorizationException thrown = Assertions.assertThrows( NeoComAuthorizationException.class,
				() -> fittingListController.getPilotFittings( 100 ),
				"Expected fittingListController.getPilotFittings() to throw null verification, but it didn't." );
	}
	...
	public void getPilotFittingsSuccess() {
		...
		// Test
		ResponseEntity<List<Fitting>> obtainedResponseEntity = fittingListController.getPilotFittings( pilotId );

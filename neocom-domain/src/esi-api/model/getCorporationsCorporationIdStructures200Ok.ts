...
export namespace GetCorporationsCorporationIdStructures200Ok {
    export type StateEnum = 'anchor_vulnerable' | 'anchoring' | 'armor_reinforce' | 'armor_vulnerable' | 'deploy_vulnerable' | 'fitting_invulnerable' | 'hull_reinforce' | 'hull_vulnerable' | 'online_deprecated' | 'onlining_vulnerable' | 'shield_vulnerable' | 'unanchored' | 'unknown';
    export const StateEnum = {
        ...
        DeployVulnerable: 'deploy_vulnerable' as StateEnum,
